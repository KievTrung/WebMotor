...
<body class="poppins-regular">
	...
	<div class="account-page-custom"
		style="background-image: url(<c:url value="/resources/images/login.jpg" />)">
		<div class="container">
			<div class="form-container-custom">
				<div class="form-btn">
					<div style="color: red; font-size: 14px">${msg}</div>
					<form action="changePassword" method="post">
						<input type="password" placeholder="Type new password" name="new">
						<input type="password" placeholder="Cofirm new password"
							name="renew"> <input type="text"
							placeholder="Type authentication code" name="code"> <input
